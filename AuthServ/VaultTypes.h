...
#define NODE_FIELD(type, name) \
    ...
    public:
        ...
        NODE_FIELD(ST::string,  String64_1      )
        NODE_FIELD(ST::string,  String64_2      )
        NODE_FIELD(ST::string,  String64_3      )
        NODE_FIELD(ST::string,  String64_4      )
        NODE_FIELD(ST::string,  String64_5      )
        NODE_FIELD(ST::string,  String64_6      )
        NODE_FIELD(ST::string,  IString64_1     )
        NODE_FIELD(ST::string,  IString64_2     )
        NODE_FIELD(ST::string,  Text_1          )
        NODE_FIELD(ST::string,  Text_2          )
