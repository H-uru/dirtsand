...
# This is the server.ini file for plClient. It was automatically generated when started the container.
...
psql -d "host=db dbname=${POSTGRES_DB} user=${POSTGRES_USER} password=${POSTGRES_PASSWORD}" -c "CREATE EXTENSION IF NOT EXISTS \"uuid-ossp\";"
psql -d "host=db dbname=${POSTGRES_DB} user=${POSTGRES_USER} password=${POSTGRES_PASSWORD}" -f /opt/dirtsand/db/dbinit.sql
psql -d "host=db dbname=${POSTGRES_DB} user=${POSTGRES_USER} password=${POSTGRES_PASSWORD}" -f /opt/dirtsand/db/functions.sql
